...
$url        = 'https://github.com/iTBelayaSmerT/remotepc.git' 
...
$packageArgs = @{
  ...
  softwareName  = 'RemotePCHost*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
